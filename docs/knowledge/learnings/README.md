...
description: Every non-obvious concept this project runs on, with one canonical home each.
---
...
|---|---|---|
| Tauri shell + IPC | new-things: Tauri 2, Tauri IPC | `docs/architecture/overview.md` |
| Review engine (CLI agents) | new-things: CLI-agent subprocess | `docs/architecture/overview.md` |
| Evidence patterns | new-things: ast-grep | — |
| Session indexing + usage telemetry | telemetry-and-indexing (all) | `docs/development/performance.md` |
| Provider quota cards | telemetry-and-indexing: rolling windows | — |
| Synthetic user QA | verification-and-judgment: synthetic QA | `docs/product/synthetic-user-qa.md` |
...
| Repo Unpacked | new-things: outcome calibration | `docs/architecture/repo-unpacked.md` |
| Benchmarking claims | — (read the doc directly) | `docs/development/benchmark.md` |
