> **Superseded 2026-07-18** by `docs/development/setup.md`. This doc referenced npm workspaces, `packages/` builds, and `apps/dashboard` — all removed. Kept for git history.
