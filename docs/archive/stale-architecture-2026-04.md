> **Superseded 2026-07-18** by `docs/architecture/overview.md`. This doc describes the pre-desloppification monorepo (`packages/`, `workers/`, `apps/dashboard`) which no longer exists. Kept for git history.
