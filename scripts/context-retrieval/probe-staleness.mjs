...
function parseArgs(args) {
  ...
  for (let index = 0; index < args.length; index += 1) {
    ...
    else if (argument === '--graphify') options.graphifyBinary = value;
    else if (argument === '--codesearch') options.codesearchBinary = value;
    else if (argument === '--tool') options.fixtureTool = value;
    else if (argument === '--zoekt') options.zoektBinary = value;
    else if (argument === '--semble') options.sembleBinary = value;
    else if (argument === '--cache-dir') options.cacheDir = value;
    else if (argument === '--out') options.out = value;
    else if (argument === '--max-cases') options.maxCases = Number.parseInt(value, 10);
