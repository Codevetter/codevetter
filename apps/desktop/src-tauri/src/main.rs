...
fn main() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::rubric_settings::get_rubric_settings,
            commands::rubric_settings::set_active_rubric_pack,
            commands::rubric_settings::save_rubric_pack,
            ...
            commands::session_retention::plan_session_retention,
            commands::session_retention::apply_session_retention,
            commands::session_retention::set_session_retention_pin,
            commands::session_retention::compact_session_archive,
            ...
            commands::managed_work::list_managed_provider_profiles,
            commands::managed_work::create_managed_work_run,
            commands::managed_work::list_managed_work_runs,
            commands::managed_work::attach_managed_work_process,
            commands::managed_work::reconcile_managed_work_run,
            commands::managed_work::run_managed_work_hook,
            commands::managed_work::get_managed_work_handoff,
            commands::managed_work::archive_managed_work_run,
            commands::managed_work::create_intent_closure,
            commands::managed_work::list_intent_closures,
            commands::verification_qa::get_qa_support_matrix,
            commands::verification_qa::preview_warm_verification_artifact,
            ...
            commands::structural_graph::api::export_structural_graph_public_package,
