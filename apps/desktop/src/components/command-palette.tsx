  ...
  const commands: CommandItem[] = useMemo(() => {
    ...
    return [
      ...
      },
      {
        id: 'nav-repo',
        label: 'Go to Repo',
        description: 'Unpack brief, Intel attribution, and workspace export',
        icon: '\u25A3',
        shortcut: 'g p',
        group: 'Navigation',
        action: go('/unpack'),
      ...
      {
        id: 'nav-intel',
        label: 'Go to Repo (Intel tab)',
        description: 'Git attribution and DORA signals for the active project',
        icon: '\u25C7',
        shortcut: 'g i',
        group: 'Navigation',
        action: go('/unpack?section=intel'),
      },
      {
        id: 'nav-trex',
        label: 'Go to T-Rex',
