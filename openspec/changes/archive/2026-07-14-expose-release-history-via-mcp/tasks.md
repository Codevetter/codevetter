...
- [x] 4.7 Add golden-schema and behavior tests, including reference graph implementation parity queries, release/commit/date time travel, ambiguous lineage, regression tracing, and the analytics-event case where code emission is evidenced but provider ingestion remains unknown.
