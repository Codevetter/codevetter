# Local session retention Specification

## Purpose

Define measured, plan-first cleanup of CodeVetter's local normalized session
archive while preserving provider-owned transcripts and referenced evidence.
