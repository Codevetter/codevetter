# Work agent team recommendation Specification

## Purpose

Define how Work recommends, confirms, launches, stages, and restores a bounded team of local agents while preserving explicit permissions and honest session identity.
