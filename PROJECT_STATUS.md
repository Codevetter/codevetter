...
- **2026-07-04 — Per-finding usefulness tracking:** accept/dismiss disposition on review findings (`local_review_findings.disposition`), per-review counts in the findings panel, dismissed findings excluded from bulk fix selection, and an all-time/30-day acceptance-rate strip on Roadmap — the direct signal for whether review findings are worth acting on.
