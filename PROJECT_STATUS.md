...
- Graphify node-link JSON importable via explicit bounded local file action; supported confidence/source/community metadata is preserved in a non-mutating preview, with actionable malformed/oversized/dangling-endpoint errors.
